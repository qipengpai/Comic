...
public class CartoonData extends BaseEntityVO{
	...
	private String firsrtType = "";  //类型
	private String followState = "";  //000 已关注发0 
	private String cartoonModelId = "";  //模块Id
	...
	public void setCartoonModelId(String cartoonModelId) {
		this.cartoonModelId = cartoonModelId;
	}
