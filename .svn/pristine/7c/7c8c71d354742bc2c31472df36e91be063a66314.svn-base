...
public class CartoonVo extends BaseEntityVO {

	private String id;
	private String cartoonType; // 类型
	private String firsrtType; // 一级类型
	...
	private String sortNum; // 排序调整（ 向下排序--0 向上排序--1 置顶--2）
	...
	private String mode; // 查询条件
	private String cartoonSetId;
	private String hotState; // 给热门查询用的状态
	private String updateDate;	 //更新时间
	private String serialState = ""; // 連載類型
	private String iosState = "";           //ios漫画上架状态状态
	private String anroidState = "";           //android漫画上架状态状态
	private String distributorState = "";           //分销商漫画上架状态状态
	private String recommendationIndex = "";           //推荐指数
	...
	public String getFirsrtType() {
		return firsrtType;
	}

	public void setFirsrtType(String firsrtType) {
		this.firsrtType = firsrtType;
	}
