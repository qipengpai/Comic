...
public class ActionUrl {
	...
	// 苹果支付前生成订单
	public static final String GENERATE_APP_ORDER = "/app/ios/qpp/generateOrder";
	...
	public static final String CHACK_VIP = "/app/Check/vip";
	// h5>个人中心>完成关注平台任务
	public static final String FINISH_FOLLOW_TASK = "/qpp/H5/finish/task";
	...
	// H5用户完善资料
	public static final String USER_PERFECT_INFO_H5 = "/h5/user/perfect/info";
	// 用户更换头像
	...
	// 生成EXCEL
	public static final String EXPORT_EXCEL = "/qpp/pc/comic/add/exportExcel";
	...
	// 删除漫画推广标题
	public static final String DISTRIBUTOR_DELETE_DISTRIBUTION_CARTOONTITLE = "/crxl/qpp/distributor/deleteDistributiontitle";
	...
	// 删除漫画推广文案封面
	public static final String DISTRIBUTOR_DELETE_DISTRIBUTION_CARTOONCOVER = "/crxl/qpp/distributorcover/deleteDistributioncover";
	...
	// 查询漫画模块
	public static final String SELECT_CARTOON_MODEL = "/crxl/qpp/admin/selectCartoonModel";
	// 查询漫画模块Id
	public static final String SELECT_CARTOON_MODEL_BYID = "/crxl/qpp/admin/selectCartoonModelById";
	// 修改漫画模块
	public static final String UPDATE_CARTOON_MODEL = "/crxl/qpp/admin/uodateCartoonModel";
	// 增加漫画模块
	public static final String ADD_CARTOON_MODEL  = "/crxl/qpp/admin/addCartoonModel";
	// 删除漫画模块
	public static final String DELETE_CARTOON_MODEL  = "/crxl/qpp/admin/deleteCartoonModel";

	// 查看该漫画 所有模块
	public static final String SELECT_THIS_CARTOON_MODEL = "/crxl/qpp/admin/selectThisCartoonModel";
	// 修改漫画模块
	public static final String UPDATE_THIS_CARTOON_MODEL = "/crxl/qpp/admin/uodateThisCartoonModel";
	// 删除漫画的漫画模块
	public static final String DELETE_THIS_CARTOON_MODEL  = "/crxl/qpp/admin/deleteThisCartoonModel";
	// 增加漫画的漫画模块
	public static final String ADD_THIS_CARTOON_MODEL  = "/crxl/qpp/admin/addThisCartoonModel";
	// 查看可增加的漫画模块
	public static final String SELECT_ADD_THIS_CARTOON_MODEL  = "/crxl/qpp/admin/selectAddThisCartoonModel";
	
	// 根据模块查询漫画 （管理）
	public static final String SELECT_CARTOON_BY_MODEL  = "/crxl/qpp/admin/selectCartoonByModel";
	// 根据模块升降序漫画 
	public static final String UPDATE_CARTOONSORT_BYMODEL = "/crxl/qpp/admin/updateCartoonSortByModel";
	// 模块查询漫画
	public static final String GET_ALL_CARTOON_BYMODEL = "/crxl/qpp/h5/selectH5CartoonByModel";
	// 模块查询漫画(更多) 
	public static final String GET_ALL_CARTOON_BYMODEL_MORE = "/crxl/qpp/h5/selectH5MoreCartoonByModel";
	// 查询免费漫画
	public static final String GET_ALL_FREE_CARTOON = "/crxl/qpp/selectFreeCartoon";
