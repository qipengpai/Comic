...
import cn.swiftpass.util.MD5;
import cn.swiftpass.util.RandomUtil;
...
public class GateWayService {
     ...
     * @see [类、类#方法、类#成员]
     */
    public void pay(HttpServletRequest req, HttpServletResponse resp,String openId) throws ServletException, IOException {
        log.debug("支付请求...");
        String money = req.getParameter("total_fee");
        SortedMap<String, String> map = XmlUtils.getParameterMap(req);
        map.put("sub_appid", "wx053e2bdaaf81ab7a");
