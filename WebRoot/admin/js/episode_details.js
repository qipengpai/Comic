...
/*页码的上一个*/
function leftcenter(){
	nowpage02 = ($(".pagination-num").val()>1)?$(".pagination-num").val()-1:1;
	pagenum02 = $(".pagination-page-list").val();
	mallwatch()
...
function rightbottom(){
	nowpage02 = $(".pagination-data").html();
	pagenum02 = $(".pagination-page-list").val();
	mallwatch()
...
function rightcenter(){
	nowpage02 = ($(".pagination-num").val()<$(".pagination-data").html())?(parseInt($(".pagination-num").val())+1):$(".pagination-data").html();
	pagenum02 = $(".pagination-page-list").val();
	mallwatch()
...
/*改变列表的个数*/
function change(){
	nowpage02 = (parseInt($(".pagination-num").val())<parseInt($(".pagination-data").html()))?(parseInt($(".pagination-num").val())):$(".pagination-data").html();
	pagenum02 = $(".pagination-page-list").val();
	mallwatch()
}
